---
description: 变更用户在各游戏类型设置的投注限制清单。
---
...
<table><thead><tr><th>参数</th><th>格式</th><th>描述</th><th data-hidden>范例</th></tr></thead><tbody><tr><td>updateGameList</td><td><mark style="color:orange;">array</mark></td><td>更新投注限额游戏。阵列值为gameType。</td><td>预设随机生成</td></tr><tr><td>username</td><td><mark style="color:blue;">number</mark></td><td>用户名。</td><td><pre><code>apitest01
